...
export const WORK_DEMO_DATA: WorkData = {
  items: [
    { id: 'work-qc-318', source: 'warehouse', title: 'Inspect receipt RCPT-318', description: '3 receipt lines require evidence-backed quality inspection.', status: 'awaiting inspection', priority: 'high', dueAt: '2026-07-14T09:00:00+08:00', href: '/warehouse/quality' },
