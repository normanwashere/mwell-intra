...
export const INSTRUMENT_TEMPLATES: readonly InstrumentTemplate[] = [
  {
    ...
    riskTiers: [],
    body: [
      'This Mutual Non-Disclosure Agreement is entered into by Metro Pacific Health Tech Corporation / mWell ("mWell") and the service provider identified on the accreditation case ("Vendor").',
      'The parties may exchange confidential or proprietary information while evaluating or performing a potential technology engagement, including software development, systems integration, consultancy, technical services, architecture, pricing, product roadmap, security, operations, and business information ("Confidential Information").',
      'The receiving party shall (a) use Confidential Information solely for the potential transaction or approved engagement; (b) protect it with at least the same care it applies to its own confidential information, never less than reasonable care; and (c) restrict access to representatives with a need to know who are bound by confidentiality duties at least as protective as this NDA.',
      ...
      'Each party remains responsible for breaches by its representatives. The existence and terms of the discussions are treated as Confidential Information unless mWell approves disclosure in writing.',
      'Where Confidential Information includes personal data, the Vendor must comply with the Data Privacy Act of 2012 (RA 10173), applicable National Privacy Commission issuances, and any data-processing agreement or written security instruction issued by mWell.',
      'The obligations in this NDA survive for five (5) years from the date of disclosure. Trade secrets and personal-data protection obligations survive for as long as they remain protected by law. All Confidential Information remains the property of the disclosing party.',
