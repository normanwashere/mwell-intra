...
export const CAPABILITY_CLASSIFICATIONS: readonly CapabilityClassification[] = [
  ...
  mutationCapability('warehouse', 'recommend_replenishment'),
  mutationCapability('warehouse', 'register_exports'),
  mutationCapability('warehouse', 'review_exports'),
  ...
  mutationCapability('procurement', 'cancel_purchase_order'),
  mutationCapability('procurement', 'manage_replenishment'),
