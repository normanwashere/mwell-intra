...
const profiles: Profile[] = [
  {
    ...
    name: "Marco Reyes",
    email: "marco.reyes@mwell.com.ph",
  ...
  },
  {
    ...
    role: "business_unit",
    name: "Patricia Lim",
    email: "patricia.lim@mwell.com.ph",
  ...
  },
  {
    ...
    role: "marketing",
    name: "Miguel Santos",
    email: "miguel.santos@mwell.com.ph",
...
const products: Product[] = [
  ...
  ...[
    ["pack-label", "PACK-LABEL", "Shipping Label", "sheet", "4900099910"],
    ["pack-pouch", "PACK-POUCH", "Courier Pouch", "pouch", "4900099911"],
    ["pack-small-box", "PACK-BOX-S", "Small Shipping Box", "box", "4900099912"],
    ["pack-bubble-wrap", "PACK-BUBBLE", "Bubble Wrap", "roll", "4900099913"],
    ["pack-tape", "PACK-TAPE", "Packing Tape", "roll", "4900099914"],
  ].map<Product>(([id, sku, name, uom, barcode]) => ({
    id: id!,
    sku: sku!,
    name: name!,
    category: "merchandise",
  ...
  })),
  {
    id: "tool-cutter",
    sku: "TOOL-CUTTER",
    name: "Warehouse Cutter",
    category: "merchandise",
    itemClass: "warehouse_tool",
    serializationPolicy: "asset_tag",
    uom: "piece",
    serialized: true,
    attributes: {},
    unitCost: 180,
...
const multiSiteUnits: InventoryUnit[] = [
  {
    id: "ecg-ring-10-cebu1",
    productId: "ecg-ring-10",
    serialNumber: "ECG-RING-10-CB0001",
    locationId: "loc-cebu",
    status: "in_stock",
  },
  {
    id: "ecg-ring-10-cebu2",
    productId: "ecg-ring-10",
    serialNumber: "ECG-RING-10-CB0002",
    locationId: "loc-cebu",
    status: "in_stock",
  },
  {
    id: "smart-watch-cebu1",
    productId: "smart-watch",
  ...
  {
    id: "smart-watch-cebu2",
    productId: "smart-watch",
    serialNumber: "SMART-WATCH-CB0002",
    locationId: "loc-cebu",
    status: "in_stock",
  },
  {
    id: "smart-watch-makati1",
    productId: "smart-watch",
    serialNumber: "SMART-WATCH-MK0001",
    locationId: "loc-event-makati",
    status: "in_stock",
  },
  {
    id: "sleep-ring-8-cebu1",
    productId: "sleep-ring-8",
    serialNumber: "SLEEP-RING-8-CB0001",
    locationId: "loc-cebu",
    status: "in_stock",
  },
];
...
const fieldAssignedUnits: InventoryUnit[] = [
  {
    id: "ecg-ring-10-fld1",
    productId: "ecg-ring-10",
    serialNumber: "ECG-RING-10-FLD001",
    locationId: "loc-event-makati",
    status: "issued",
  ...
  },
  {
    ...
    serialNumber: "ECG-RING-8-FLD001",
    locationId: "loc-event-lgu",
    status: "issued",
    assignedTo: "Dr. Santos",
    eventId: "evt-lgu",
  },
...
const events: WarehouseEvent[] = [
  {
    id: "evt-makati",
    name: "Makati Corporate Wellness Day",
    type: "corporate",
    siteLocationId: "loc-event-makati",
    startDate: "2026-06-10",
  },
  {
    id: "evt-lgu",
    name: "Bataan LGU Medical Mission",
    type: "medical_mission",
    siteLocationId: "loc-event-lgu",
    startDate: "2026-06-18",
  },
  {
    id: "evt-vip",
    name: "VIP Doctor Appreciation",
    type: "vip_activation",
    startDate: "2026-06-25",
  },
  {
    id: "evt-smx",
    name: "SM Megamall B2C Activation",
    type: "b2c",
    startDate: "2026-07-02",
  },
  {
    id: "evt-bgc",
    name: "BGC Corporate Health Fair",
    type: "corporate",
...
export function buildActivityHistory(now: Date = new Date()): ActivityHistory {
  ...
  for (let day = 89; day >= 0; day -= 2) {
    ...
    const qty = Math.max(
      1,
      Math.round(target.base * ramp * (0.6 + rand() * 0.8)),
    );
    extraMovements.push({
      id: `mv-h${mvSeq++}`,
      type: "issue",
  ...
  const upcomingAllocations: Allocation[] = [
    {
      id: "alloc-h1",
      eventId: "evt-cebu-mission",
      productId: "shirt-m",
      quantity: 80,
      status: "reserved",
      promotional: true,
      createdAt: isoDaysAgo(now, 3, 10),
    },
    {
      id: "alloc-h2",
      eventId: "evt-cebu-mission",
      ...
      status: "reserved",
      promotional: true,
      createdAt: isoDaysAgo(now, 3, 10, 15),
    },
    {
      id: "alloc-h3",
      eventId: "evt-cebu-mission",
      productId: "ecg-ring-9",
      quantity: 4,
      status: "reserved",
      createdAt: isoDaysAgo(now, 2, 9),
    },
  ];
