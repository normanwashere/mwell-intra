...
export function rowToFulfillmentOrder(r: Row): FulfillmentOrder {
  return {
    ...
    ecommerceChannel: r.ecommerce_channel ?? undefined,
    ...
    paymentRrn: r.payment_rrn ?? undefined,
    paymentProviderMethod: r.payment_provider_method ?? undefined,
    paymentProviderStatus: r.payment_provider_status ?? undefined,
    campaignName: r.campaign_name ?? undefined,
    salesInvoiceNumber: r.sales_invoice_number ?? undefined,
    shippingFee: r.shipping_fee == null ? undefined : Number(r.shipping_fee),
    otherFees: r.other_fees == null ? undefined : Number(r.other_fees),
    reportedTotalAmount:
      r.reported_total_amount == null
        ? undefined
        : Number(r.reported_total_amount),
    ...
    shipmentEvents: r.shipment_events ?? [],
