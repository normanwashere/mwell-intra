...
**Next layout candidate, not yet live:** The pick form keeps its full reference under **Order reference** and the condition reminder under **Quality checkpoint**. New errors scroll into view without clearing scans. Packing confirmation stays on the order or below the filters; an operator other than the packer still performs release. This candidate passed 158 fulfillment tests and 30 browser checks across six widths. It does not change the required process steps.
