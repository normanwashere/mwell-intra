...
**Receiving:** Open the matching eligible PO in Receive and inspect. Confirm the product variant, quantities and required evidence. Keep jacket sizes on separate lines. Record the actual condition breakdown; do not mark damaged units as accepted. Complete governed receipt and independent Quality inspection, then Put away accepted stock into the correct bin. Stock in inspection or on hold is not automatically available for requests. The current governed PO dialog does not capture an actual delivery date; retain the dated delivery note as evidence and report the missing field rather than treating the expected PO date as the actual delivery date.
