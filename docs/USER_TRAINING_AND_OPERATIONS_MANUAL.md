...
When checking an existing Procurement Admin version-2 assignment or payment-review certificate, expect the verified role context **Procurement / Procurement Admin**. Compare it with the learner's actual assignment and recorded result, not a guessed payment-readiness curriculum name. The presentation alias must not change progress, activate access or stand in for payment-release evidence; unknown roles, modules, audiences and versions remain unidentified.
