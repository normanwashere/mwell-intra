...
- Exhaustive migration from all 368 maintained legacy tab, article, and heading routes. The original August 24 certification covered 313; eighteen source-registry routes were added on August 28 and 37 article/heading routes across updated maintained sources on September 5, including all three candidate guides. Later routes require their own verification and do not inherit the historical browser certification. August captures are stale under the unchanged seven-day gate as of September 5; historical-fixture unit tests do not recertify images.
