...
Reusable event watch variants stay active; Product decides when to retire them. Returned watches still require inspection and a Product-approved recovery recipe. Continue seller testing on the separate September 21 synthetic event and its newly approved three-watch/two-material request. The September 20 event and tester stock are preserved. Receive, inspect, put away, allocate, pick, pack, release and acknowledge the new stock before claiming seller or Finance completion. SMTP is unchanged, and automated accounts are not a real-user pilot.
