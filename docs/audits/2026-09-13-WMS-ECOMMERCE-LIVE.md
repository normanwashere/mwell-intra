...
The earlier `55b66a58` ecommerce batch remains at Received; `fbceedf7` still contains two completed orders and two private synthetic photos. These two batches still need scoped cleanup. Testers should leave WMS-ECOM fixtures untouched. Existing tester data is outside this scope.
