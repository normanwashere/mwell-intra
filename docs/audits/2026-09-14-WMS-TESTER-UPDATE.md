...
Next up: a clearer replenishment entry for Operations, the remaining isolated-role journeys, and older KB flow labels that still mix up Operations and Warehouse Operator. The actual user/device pilot is also open. SMTP is not included.
