...
- Live responsive crawl: 66 role/viewport combinations covered 1440px, 1280px, 768px, 390px, 360px, and 320px. The initial crawl found insecure Operations evidence, missing Procurement deep-link visibility, and a 320px My Work overflow caused by long source-record identifiers. Evidence resolution, role visibility, identifier wrapping, and narrow-screen navigation are now covered by regression certificates.
