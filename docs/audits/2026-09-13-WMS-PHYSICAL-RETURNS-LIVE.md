...
Independent review subsequently passed the own-actor reader and caller, including 76 tests plus additional malformed, denied, incomplete and foreign-row probes. This verifies the test correction, not physical return completion. A third distinct run, `177f0c97-a6de-4ee4-82b1-37a09f4f5e37`, is now running under `outputs/wms-signoff/sep13-physical-returns-actor-scoped-live` against the same build. Its fresh insert-only fixtures were independently read back at `2026-09-13T15:00:16.750336Z`. No result is claimed before terminal completion.
