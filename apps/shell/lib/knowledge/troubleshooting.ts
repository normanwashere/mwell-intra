...
export const TROUBLESHOOTING_GUIDES: TroubleshootingGuide[] = [
  ...
  },
  {
    ...
    safeRecovery: [
      ...
      "Follow the training assigned to you in Onboarding. A new permission is not proof that you completed training for it. If the required task training is missing or unclear, ask your administrator to check the published assignment; do not repeat unrelated practice to try to unlock it",
  ...
  },
  {
    ...
    safeRecovery: [
      ...
      "Older receipts may show External evidence instead of a photo. Open the link in a new tab to check the original website. Its availability and contents are not verified by the app. If it is wrong or unavailable, send the receipt reference to your Warehouse lead and ask for the correct supporting document; do not repeat receiving or change a Quality decision to repair the link",
      "On a small screen, mixed photos and website links appear in two columns. Check the displayed website address before opening External evidence. Opening either attachment type is read-only and does not confirm inspection or delivery",
