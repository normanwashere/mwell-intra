...
const appCommit = "11e1fec866c6537ed340111550b9a1ce341a0a58";
...
export const KNOWLEDGE_EVIDENCE_SCENARIOS: Record<string, EvidenceScenario> = {
  ...
  "access-fix": {
    route: "/admin/users",
    state: "The platform administrator is reviewing the seeded scoped-role access matrix.",
    landmark: "Users and scoped role assignments",
    label: "Scoped role assignment",
    instruction: "Review the account's scoped grants before applying the minimum approved role.",
    x: 0.1727,
    y: 0.4027,
    mobileX: 0.3093,
    mobileY: 0.3953,
  ...
  "p2p-payment-pack": {
    ...
    state: "Finance is reviewing the seeded closed PO acceptance and payment-readiness panel.",
    landmark: "Acceptance and payment readiness",
    label: "Payment readiness",
    instruction: "Review the PO, receipt, acceptance, invoice, and amount match before deciding readiness.",
    x: 0.489,
    y: 0.4027,
    mobileX: 0.5,
    mobileY: 0.3962,
  ...
  "receive-record": {
    ...
    state: "The logistics supervisor is preparing a seeded product quantity for the receipt draft.",
  ...
  "quality-release": {
    route: "/warehouse/quality",
    state: "The seeded inspection sheet is set to Accepted for putaway.",
  ...
  "return-quarantine": {
    route: "/warehouse/quality",
    state: "The logistics supervisor has set a seeded inspection to Place on hold.",
    landmark: "Submit inspection",
  ...
  "count-post": {
    ...
    state: "The warehouse administrator is reviewing a deterministic pending stock change before governed posting.",
    landmark: "Review",
    label: "Review stock change",
    instruction: "Review the supported stock change and its approval path before posting an auditable movement.",
    x: 0.9359,
    y: 0.3409,
    mobileX: 0.5,
    mobileY: 0.4998,
  ...
  "admin-start": {
    ...
    landmark: "Access matrix",
    label: "Open administration request",
    instruction: "Match the request owner, scope, and approval evidence to the access matrix.",
    x: 0.1727,
    y: 0.4027,
    mobileX: 0.3093,
    mobileY: 0.3953,
  ...
  "admin-activate": {
    route: "/admin/doa",
    state: "The platform administrator is reviewing a seeded DOA draft before controlled activation.",
    landmark: "Save draft",
    label: "Save approved configuration",
    instruction: "Save the reviewed configuration with version and audit history before activation.",
    x: 0.9016,
    y: 0.8793,
    mobileX: 0.5,
    mobileY: 0.6391,
  ...
  "doa-activate": {
    route: "/admin/doa",
    state: "Legal administration is reviewing the seeded DOA revision before saving and superseding.",
    landmark: "Save draft",
    label: "Save DOA revision",
    instruction: "Save the reviewed revision before deliberate activation and supersession.",
    x: 0.9016,
    y: 0.8793,
    mobileX: 0.5,
    mobileY: 0.6391,
