...
export const EXPLICIT_FEATURE_DETAILS: Record<string, ExplicitFeatureDetails> =
  {
    ...
    "warehouse-finance": {
      controls: [
        control(
          "Change valuation scope",
          "Filters valuation measures by warehouse, period, or category.",
          "The scope must use visible warehouse and valid period values.",
          "Financial measures recalculate for the selected scope.",
        ),
        control(
          "Open product valuation",
          "Opens product detail from a valuation row.",
          "The product identifier must remain valid.",
          "Authorized cost and movement context appears.",
        ),
        control(
          "Review reconciliation",
          "Shows ledger and operational totals behind a variance.",
          "The selected period must have loaded source records.",
          "Source quantities and values can be compared.",
        ),
        control(
          "Export finance view",
          "Downloads the authorized valuation or reconciliation view.",
          "The role needs view_finance and a valid export scope.",
          "A governed finance artifact downloads.",
        ),
      ],
      fields: [
        field(
          "Warehouse",
          "Scopes finance measures to one site.",
          false,
          "The warehouse must remain active and visible.",
        ),
        field(
          "Valuation date",
          "Sets the as-of point for displayed value.",
          true,
          "Use a valid date supported by available ledger history.",
        ),
        field(
          "Product category",
          "Optionally narrows valuation rows.",
          false,
          "The category must exist when selected.",
        ),
        field(
          "Reconciliation state",
          "Filters current, pending, or variance records.",
          false,
          "Use one supported finance state.",
        ),
      ],
    },
    "warehouse-pricing": {
