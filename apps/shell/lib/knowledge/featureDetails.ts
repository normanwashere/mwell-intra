    ...
    "procurement-request-detail": {
      controls: [
        ...
        control(
          ...
          "Records the officer-selected route and risk facts. A confirmed request can show sourcing as Not started until a plan exists. Reopen the same request to review saved sourcing and evaluation evidence; a failed read offers Retry sourcing. Deadline entry and summary use your device's local time; reopening and saving an unchanged deadline must not shift it. Report any mismatch before issuing the package. Viewing evidence does not grant independent variance-review or award authority. Restricted variance history is explicitly identified, not treated as no decisions.\n\nFollow the recorded sourcing stage, not a later-stage instruction: Not started means prepare the plan; draft means complete the plan and accredited invitations before governed issue. Only an issued event proceeds through response handling and controlled window closure. Closed responses lead to governed evaluation; evidence, any required independent review and award remain separate steps. Failed bids use recovery controls; awarded or cancelled events retain their history. Loading or failed reads do not establish a next step. Stage guidance does not enable an action or prove it was completed.",
