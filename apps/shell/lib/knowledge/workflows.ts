  ...
  flow(
    ...
    [
      ...
      process(
        ...
        "Record the unique invoice or SI number, invoice and due dates, invoice value, tax and withholding, and private evidence references. The database compares the invoice with accepted unpaid value and the PO; users do not self-attest the match.",
      ),
      decision(
        "p2p-finance-review",
  ...
  flow(
    ...
    [
      ...
      decision(
        ...
        ["product_owner"],
        "Approve or reject the current submitted version with a specific decision note. A stale or previously decided version cannot be decided again.",
        "product_owner",
      ...
      decision(
        ...
        ["product_operations_partner"],
        "Confirm the approved version, launch conditions, accountable owners, and operational capacity before acknowledging once.",
        "product_operations_partner",
