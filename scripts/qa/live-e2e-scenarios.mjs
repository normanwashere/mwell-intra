...
export const CURRENT_LIVE_ROLES = [
  ...
  persona("warehouse_bi_analyst", "intra.test.wh.bi@mwell.com.ph", { core: ["staff"], warehouse: ["bi_analyst"] }, "technology"),
  persona("warehouse_business_unit", "intra.test.wh.business.unit@mwell.com.ph", { core: ["staff"], warehouse: ["business_unit"] }, "operations"),
  persona("warehouse_marketing", "intra.test.wh.marketing@mwell.com.ph", { core: ["staff"], warehouse: ["marketing"] }, "marketing"),
