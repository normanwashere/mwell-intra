...
const coverage = {
  ...
  'replenishment.recommend': [null, 'Operations recommendation entry, effective command authority, accepted-snapshot race protection and complete live evidence adapter missing. Invalid-quantity probes earn no journey credit.'],
  'replenishment.accept': [null, 'Procurement acceptance, Operations-only denial and separate dismissal fixture evidence missing.'],
  'replenishment.handoff': [null, 'Linked draft request, duplicate-handoff protection, audit and no-stock-mutation reconciliation evidence missing.'],
