...
if (!baseUrl || !password)
  throw new Error("AUDIT_BASE_URL and AUDIT_PASSWORD are required.");
...
await capture({
  name: "01-sign-in-desktop",
  viewport: { width: 1440, height: 900 },
  route: "/login",
  fullPage: false,
});
await capture({
  name: "02-sign-in-mobile",
  viewport: { width: 390, height: 844 },
  route: "/login",
  fullPage: false,
});
await capture({
  name: "03-command-center-admin-desktop",
  viewport: { width: 1440, height: 900 },
  email: "intra.test.admin@mwell.com.ph",
});
await capture({
  name: "04-admin-users-mobile-320",
  viewport: { width: 320, height: 720 },
  email: "intra.test.admin@mwell.com.ph",
  route: "/admin/users",
});
await capture({
  name: "05-procurement-list-desktop",
  viewport: { width: 1440, height: 900 },
  email: "intra.test.employee@mwell.com.ph",
  route: "/procurement",
});
await capture({
  name: "06-procurement-request-mobile-320",
  viewport: { width: 320, height: 720 },
  email: "intra.test.employee@mwell.com.ph",
  route: "/procurement/requests/new",
});
await capture({
  name: "07-procurement-created-desktop",
  viewport: { width: 1440, height: 900 },
  email: "intra.test.employee@mwell.com.ph",
  route: "/procurement/requests/req_0c335433cb79423e9ad0c45a4f0c1f22",
});
await capture({
  name: "08-legal-cases-desktop",
  viewport: { width: 1440, height: 900 },
  email: "intra.test.legal.lead@mwell.com.ph",
  route: "/legal",
});
await capture({
  name: "09-legal-invite-mobile",
  viewport: { width: 390, height: 844 },
  email: "intra.test.legal.lead@mwell.com.ph",
  route: "/legal/invites/new",
});
await capture({
  name: "10-vendor-portal-mobile",
  viewport: { width: 390, height: 844 },
  email: "intra.test.vendor@mwell.com.ph",
  route: "/vendor",
});
await capture({
  name: "11-warehouse-live-error-desktop",
  viewport: { width: 1440, height: 900 },
  email: "intra.test.operations.lead@mwell.com.ph",
  route: "/warehouse/receiving",
});
await capture({
  name: "12-warehouse-live-error-mobile",
  viewport: { width: 390, height: 844 },
  email: "intra.test.operations.lead@mwell.com.ph",
  route: "/warehouse/receiving",
});
