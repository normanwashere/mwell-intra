...
const CATALOG = [
  ...
  },
  {
    ...
    primaryTab: "release",
    relatedTabs: ["roles", "workflows"],
    contentType: "release-note",
    audience: ["operator", "trainer", "release-reviewer"],
    summary: "Receiving practice checkpoint correction, emergency-access wording, sourcing recovery and separate live validation limits.",
    keywords: ["receiving", "onboarding", "practice", "checkpoint", "sourcing"],
    sortOrder: 0,
    collapse: "reference",
    relatedSources: ["docs/manual/MWELL_INTRA_USER_MANUAL.md"],
  },
  ...
  },
  {
    ...
    contentType: "release-note",
    audience: ["operator", "trainer", "release-reviewer"],
    summary: "UAT release status and verification history for My Work, preserved links, handovers, scoped evidence and recovery. Read the latest status first; earlier candidate results remain historical evidence.",
  ...
  {
    source: "docs/releases/2026-08-28-AUG27-WMS-FEEDBACK.md",
    id: "aug27-wms-feedback-release",
    primaryTab: "release",
    relatedTabs: ["workflows", "roles"],
    contentType: "release-note",
    audience: ["release-reviewer", "trainer", "operator", "tester"],
    summary: "August 27 receiving progress, event reservation, return intake, and fulfillment feedback remediation.",
    keywords: ["receiving", "serial", "draft", "reservation", "returns", "backorder"],
    sortOrder: 64,
    collapse: "reference",
    relatedSources: ["docs/manual/MWELL_INTRA_USER_MANUAL.md"],
  },
  {
    source: "docs/releases/2026-08-28-CROSS-ROLE-RECOVERY.md",
    id: "cross-role-recovery-release",
    primaryTab: "release",
    relatedTabs: ["workflows", "roles", "security"],
    contentType: "release-note",
    audience: ["release-reviewer", "trainer", "operator", "tester"],
    summary: "Cross-role transaction recovery, evidence ownership, draft safety and verification boundaries.",
    keywords: ["recovery", "reservation", "evidence", "draft", "returns", "onboarding"],
    sortOrder: 65,
    collapse: "reference",
    relatedSources: ["docs/manual/MWELL_INTRA_USER_MANUAL.md"],
  },
  {
    source: "docs/releases/2026-09-05-UAT-CERTIFICATION-FOLLOWUP.md",
    id: "sep05-uat-certification-followup",
    primaryTab: "release",
    relatedTabs: ["workflows", "security"],
    contentType: "release-note",
    audience: ["release-reviewer", "trainer", "operator", "tester"],
    summary: "September 5 role-aware payment evidence, authority verification, documentation and acceptance boundaries.",
    keywords: ["uat", "certification", "payment", "evidence", "authority"],
    sortOrder: 66,
    collapse: "reference",
    relatedSources: ["docs/manual/MWELL_INTRA_USER_MANUAL.md"],
  },
  {
    source: "docs/releases/2026-09-06-ACTION-SCOPED-ONBOARDING.md",
    id: "action-scoped-onboarding-release",
    primaryTab: "release",
    relatedTabs: ["roles", "workflows", "security"],
    contentType: "release-note",
    audience: ["release-reviewer", "trainer", "operator", "tester"],
    summary: "One audience-aware checklist, authorized exploration, and action-specific learning recovery.",
    keywords: ["onboarding", "multi-role", "learning", "authority", "recovery"],
    sortOrder: 67,
    collapse: "reference",
    relatedSources: ["docs/manual/MWELL_INTRA_USER_MANUAL.md"],
  },
  {
    source: "docs/releases/2026-09-13-WMS-RECEIPT-AND-FLOOR-LAYOUT.md",
    id: "wms-receipt-floor-layout-release",
    primaryTab: "release",
    relatedTabs: ["workflows", "security"],
    contentType: "release-note",
    audience: ["release-reviewer", "trainer", "operator", "tester"],
    summary: "Recipient evidence-upload correction, focused picking and receipt layout, and WMS verification limits.",
    keywords: ["warehouse", "receipt", "picking", "evidence", "signoff"],
    sortOrder: 68,
    collapse: "reference",
    relatedSources: ["docs/manual/MWELL_INTRA_USER_MANUAL.md"],
  },
