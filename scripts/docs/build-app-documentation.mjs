...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;color:var(--ink);background:inherit}a{color:var(--brand);text-underline-offset:3px}button,input,select{font:inherit}.topbar{position:sticky;top:0;z-index:20;display:flex;align-items:center;gap:12px;min-height:72px;padding:12px 20px;background:var(--surface);border-bottom:1px solid var(--line)}.brand{display:flex;align-items:baseline;gap:8px;white-space:nowrap}.brand strong{font-size:23px;color:var(--brand)}.brand span{font-weight:700}.search-wrap{display:flex;flex:1;gap:8px;max-width:840px;margin:auto}.search-wrap input,.search-wrap select{min-height:44px;border:1px solid var(--line);border-radius:6px;background:var(--soft);color:var(--ink);padding:9px 12px}.search-wrap input{flex:1}.toolbar{display:flex;gap:8px}.toolbar button,.menu-button,.sidebar-close,.diagram-toolbar button{min-width:44px;min-height:44px;border:1px solid var(--line);border-radius:6px;background:var(--soft);color:var(--ink);cursor:pointer}.menu-button,.sidebar-close{display:none}.layout{display:grid;grid-template-columns:290px minmax(0,1fr);max-width:1600px;margin:auto}.sidebar{position:sticky;top:72px;height:calc(100vh - 72px);overflow:auto;padding:20px 16px;background:var(--surface);border-right:1px solid var(--line)}.summary{padding:14px;border-left:4px solid var(--accent);background:var(--soft);margin-bottom:18px}.summary strong{display:block;font-size:28px}.nav-group{margin:18px 0}.nav-group h2{margin:0 8px 7px;color:var(--muted);font-size:12px;text-transform:uppercase}.nav-group a{display:block;padding:8px;border-left:3px solid transparent;color:var(--ink);text-decoration:none}.nav-group a:hover,.nav-group a[aria-current="true"]{border-left-color:var(--brand);background:var(--soft);color:var(--brand)}main{min-width:0;padding:34px clamp(18px,4vw,64px) 80px}.hero{max-width:1050px;margin:0 auto 30px;padding:30px;border:1px solid var(--line);border-left:5px solid var(--brand);background:var(--surface);box-shadow:var(--shadow)}.hero h1{margin:0 0 8px;font-size:clamp(30px,4vw,48px);letter-spacing:0}.hero p{max-width:760px;color:var(--muted)}.hero-meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:18px}.hero-meta span,.category{display:inline-flex;padding:4px 8px;border-radius:4px;background:var(--soft);color:var(--brand);font-size:12px;font-weight:700}article{max-width:1050px;margin:0 auto;scroll-margin-top:92px}.article-header{display:flex;justify-content:space-between;gap:18px;align-items:flex-start;margin-bottom:20px}.article-header h1{margin:7px 0 2px;font-size:clamp(27px,3vw,38px);letter-spacing:0}.article-header p{margin:0;color:var(--muted);overflow-wrap:anywhere}.source-hash{font:12px ui-monospace,monospace;color:var(--muted);overflow-wrap:anywhere}.article-body{min-width:0;padding:26px;background:var(--surface);border:1px solid var(--line);box-shadow:var(--shadow);overflow-wrap:anywhere}.article-body h2,.article-body h3,.article-body h4{letter-spacing:0;scroll-margin-top:92px}.article-body h2{margin-top:34px;padding-top:8px;border-top:1px solid var(--line)}.article-body table{display:block;width:100%;overflow:auto;border-collapse:collapse}.article-body th,.article-body td{padding:10px;border:1px solid var(--line);text-align:left;vertical-align:top}.article-body th{background:var(--soft)}.article-body blockquote{margin:18px 0;padding:12px 16px;border-left:4px solid var(--warning);background:var(--soft)}.article-body code{font-family:"Cascadia Code",Consolas,monospace}.article-body :not(pre)>code{padding:2px 5px;border-radius:3px;background:var(--soft);white-space:normal;overflow-wrap:anywhere}.article-body pre code{white-space:pre}pre{max-width:100%;overflow:auto;padding:16px;background:#071522;color:#e7f0fa;border-radius:4px}.diagram-shell{margin:24px 0;border:1px solid var(--line);background:#fff;box-shadow:var(--shadow)}.diagram-toolbar{display:flex;justify-content:flex-end;gap:6px;padding:8px;border-bottom:1px solid var(--line);background:var(--soft)}.diagram-toolbar button{min-height:36px;min-width:40px;padding:4px 10px}.diagram-viewport{overflow:auto;padding:20px;background:#fff}.diagram-viewport .mermaid{width:100%;min-width:720px;margin:0;transition:width .15s ease}.diagram-viewport svg{display:block;width:100%!important;max-width:100%!important;height:auto}.diagram-shell figcaption{padding:8px 14px;color:#5c6d86;font-size:13px;border-top:1px solid #cad9e8}.doc-image{margin:22px 0}.doc-image img{display:block;max-width:100%;height:auto;border:1px solid var(--line);background:var(--soft)}.doc-image figcaption{color:var(--muted);font-size:13px}.back-link{display:inline-block;margin-top:18px}.document-break{max-width:1050px;margin:56px auto;border:0;border-top:1px solid var(--line)}.empty{max-width:1050px;margin:auto;padding:30px;background:var(--surface);border:1px solid var(--line)}[hidden]{display:none!important}.result-count{color:var(--muted);font-size:13px}
    ...
    @media(max-width:520px){.search-wrap{display:grid;grid-template-columns:1fr}.toolbar button{padding:0 10px}.brand span{display:none}.hero h1{font-size:30px}.article-header h1{font-size:27px}.article-body{padding:16px}.diagram-viewport .mermaid{min-width:520px}}
    @media print{.topbar,.sidebar,.back-link,.diagram-toolbar{display:none!important}.layout{display:block}main{padding:0}.hero,article{max-width:none}.hero,.article-body{box-shadow:none}.document-break{break-before:page}.article-body{border:0;padding:0}a{color:inherit;text-decoration:none}.diagram-shell{break-inside:avoid;box-shadow:none}.diagram-viewport{overflow:visible}.diagram-viewport .mermaid{transform:none!important}.diagram-viewport svg{max-width:100%!important}}
  </style>
</head>
<body id="top">
  <header class="topbar">
