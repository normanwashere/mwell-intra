...
function taskArticle(guide, guideById) {
  ...
  const stageEvidence = (stage) => {
    ...
    return `<figure class="doc-image step-screenshot" data-screen-evidence="certified" data-certified-screenshot data-screenshot-binding="${escapeHtml(stage.screenshot.bindingId)}"><button class="screenshot-trigger" type="button" data-open-screenshot-surface="${escapeHtml(screenshotId)}" aria-controls="screenshot-viewer" aria-expanded="false"><img src="${escapeHtml(screenshotSource)}" alt="${escapeHtml(label)}" loading="lazy"><span class="screenshot-action">View full screen</span></button><figcaption>${escapeHtml(label)}. Certified interaction target: ${escapeHtml(stage.screenshot.target.landmark)}.</figcaption></figure>`;
  };
