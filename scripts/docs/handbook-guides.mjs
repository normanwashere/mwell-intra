...
const TASK_DEFINITIONS = [
  ...
  },
  {
    ...
    recovery: "Retain the discrepancy, correct the receipt or obtain supervisor disposition, and resume from the controlled state. Local update, release pending: in Receiving or Quality, select an attached photo to view it full size. Close the preview to return to the unsent form; previewing does not submit the receipt or inspection.",
  ...
  },
  {
    ...
    summary: "Validate known source custody, inspect returned stock, and complete the correct customer or supplier branch. Local candidate, not yet live: Receive physical return opens optional Original order and Customer return case links; legacy unlinked intake remains supported.",
