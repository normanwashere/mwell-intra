...
const TASK_DEFINITIONS = [
  ...
  },
  {
    ...
    recovery: "Retain the discrepancy, correct the receipt or obtain supervisor disposition, and resume from the controlled state. In Receiving or Quality, select an attached photo to view it full size. Close the preview to return to the unsent form; previewing does not submit the receipt or inspection.",
    ...
    keywords: ["warehouse", "receive", "inspect", "putaway", "quality", "merchandise barcode", "tumbler", "jacket", "September 7", "UAT-SEP07-PO-0005", "UAT-SEP07-PO-0006", "UAT-SEP08-TESTER1", "UAT-SEP08-TESTER2", "UAT-AUG24-PO-0001", "UAT-AUG24-PO-0002", "UAT-AUG24-PO-0003", "Zhenzen", "Company BBB", "Company AAA", "Q-01-01"],
    ...
    sources: [
      ...
      section("receiving-merchandise-quantities", "docs/manual/MWELL_INTRA_USER_MANUAL.md", "September 7 Feedback: Merchandise Barcodes and Quantities"),
  ...
  },
  {
    ...
    summary: "Validate known source custody, inspect returned stock, and complete the correct customer or supplier branch. Receive physical return opens optional Original order and Customer return case links; legacy unlinked intake remains supported.",
  ...
  },
  {
    ...
    recovery: "Correct authority or quantity and requeue the request with its evidence. If the recorded picked bin is unavailable, review its stock and holds before retrying; release cannot substitute another bin.",
    ...
    keywords: ["department", "inventory", "request", "release", "allocation", "Marketing stock request", "multi-line demand", "merchandise barcode", "tumbler", "picked bin", "September 7"],
    sources: [
      section("inventory-release", "docs/manual/MWELL_INTRA_USER_MANUAL.md", "Inventory Release"),
      section("release-merchandise-quantities", "docs/manual/MWELL_INTRA_USER_MANUAL.md", "September 7 Feedback: Merchandise Barcodes and Quantities"),
...
const SOURCE_ROOT_HEADINGS = {
  "sept23-reporting-foundation": "Reporting Foundation Update",
  ...
  "cross-role-recovery-release": "Cross-Role Recovery and Evidence Remediation",
  "sep05-uat-certification-followup": "September 5 UAT Certification Follow-Up",
  "action-scoped-onboarding-release": "Action-scoped onboarding",
  "wms-receipt-floor-layout-release": "WMS Receipt And Floor Layout - September 13, 2026",
...
const SYSTEM_GUIDES = [
  ...
  },
  {
    ...
    sources: [
      ...
      section("outcome-first-handbook-certification", "docs/releases/2026-08-24-OUTCOME-FIRST-HANDBOOK.md", "Acceptance coverage", "governed-reference"),
...
const LEGACY_TARGET_BY_SOURCE_ID = {
  "sept23-reporting-foundation": ["system", "source-references", "source-sept23-reporting-foundation"],
  ...
  "wms-receipt-floor-layout-release": ["system", "release-qa", "source-references"],
